                ...
                <div class="card p-2 h-100 shadow-none border rounded-3">
                    <div class="card-body p-3 pt-0">
                        ...
                        <div
                            ...
                            <a class="w-100 btn btn-secondary d-flex align-items-center waves-effect"
                                href="{{ route('gameplay.schedules.qualifying', $schedule->id) }}">
                                <span class="me-2">Qualifying</span>
                            </a>
                            <a class="w-100 btn btn-outline-primary d-flex align-items-center waves-effect {{ $schedule->qualifyingResults->isEmpty() ? 'disabled' : '' }}"
                                href="{{ route('gameplay.schedules.race', $schedule->id) }}">
                                <span class="me-2">Race Day
                                </span>
                            </a>
                        </div>
                    </div>
